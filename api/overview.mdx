...
MiniFy's API is organized into seven main categories:

<CardGroup cols={2}>
  <Card title="Spotify Commands" icon="spotify" href="/api/spotify-commands">
    OAuth flow, token management, and music provider configuration for Spotify
  </Card>
  
  <Card title="YouTube Commands" icon="youtube" href="/api/youtube-commands">
    OAuth flow and credential management for YouTube Music
  </Card>
  ...
  <Card title="Debug Commands" icon="bug" href="/api/debug-commands">
...
<CardGroup cols={2}>
  <Card title="Spotify Commands" icon="spotify" href="/api/spotify-commands">
    Start with Spotify OAuth and music provider setup
  </Card>
  
  <Card title="YouTube Commands" icon="youtube" href="/api/youtube-commands">
    Set up YouTube Music as an alternative provider
  </Card>
